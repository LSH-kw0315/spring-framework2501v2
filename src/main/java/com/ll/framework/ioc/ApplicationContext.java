...
public class ApplicationContext {
    ...
    public void init() {
        Reflections reflections=
                new Reflections(basePackage,Scanners.TypesAnnotated);
        ...
        try {
            ...
            registerBeans(components);
            registerBeans(configurations);
    ...
    private void registerBeans(Set<Class<?>> classes) throws InvocationTargetException, InstantiationException, IllegalAccessException {
